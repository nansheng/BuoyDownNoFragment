...
public class DatabaseTest {
    ...
    private final Class mDbHelperClass = BuoysDbHelper.class;
     ...
     */
    @Test
    public void create_database_text() throws Exception {
        ...
        assertEquals("Error: Your database was created without the expected tables.",
                BuoysContract.BuoysEntry.TABLE_NAME, tableNameCursor.getString(0));
    ...
    public void insert_single_record_test() throws Exception{
        ...
        testValues.put(BuoysContract.BuoysEntry.COLUMN_DESCRIPTION, "test name");
        testValues.put(BuoysContract.BuoysEntry.COLUMN_LONG, 99.9);
        testValues.put(BuoysContract.BuoysEntry.COLUMN_LAT, 99.9);
    ...
    public void autoincrement_test() throws Exception{
        ...
        ContentValues testValues = new ContentValues();
        testValues.put(BuoysContract.BuoysEntry.COLUMN_DESCRIPTION, "test name");
        testValues.put(BuoysContract.BuoysEntry.COLUMN_LONG, 99.1);
        testValues.put(BuoysContract.BuoysEntry.COLUMN_LAT, 99.1);
    ...
    public void upgrade_database_test() throws Exception{
        ...
        ContentValues testValues = new ContentValues();
        testValues.put(BuoysContract.BuoysEntry.COLUMN_DESCRIPTION, "test name");
        testValues.put(BuoysContract.BuoysEntry.COLUMN_LONG, 99.5);
        testValues.put(BuoysContract.BuoysEntry.COLUMN_LAT, 99.5);
    ...
    void deleteTheDatabase(){
        try {
            ...
            fail("Make sure you havve a member called DATABASE_NAME in the BuoyslistDbHelper");
        }catch (Exception ex) {
            fail(ex.getMessage());
        }
    }
